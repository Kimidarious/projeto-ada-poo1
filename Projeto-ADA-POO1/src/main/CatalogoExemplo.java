...
public class CatalogoExemplo {
    public static void carregarDadosExemplo(CatalogoAnimes catalogo) {
        ...
        catalogo.adicionarAnime(chihiro);
        catalogo.adicionarAnime(attackOnTitan);
        catalogo.adicionarAnime(fullmetal);
        catalogo.adicionarAnime(naruto);
        catalogo.adicionarAnime(yourName);
        catalogo.adicionarAnime(demonSlayer);
        catalogo.adicionarAnime(spiritedAway);
        catalogo.adicionarAnime(bleach);
        catalogo.adicionarAnime(deathNote);
        catalogo.adicionarAnime(howl);
